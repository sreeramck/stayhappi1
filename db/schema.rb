...
ActiveRecord::Schema.define(version: 20131011174832) do
  ...
  add_index "space_photos", ["flickr_id"], name: "index_space_photos_on_flickr_id", using: :btree
  ...
  add_index "spaces", ["booking_rate_daily"], name: "index_spaces_on_booking_rate_daily", using: :btree
  add_index "spaces", ["booking_rate_monthly"], name: "index_spaces_on_booking_rate_monthly", using: :btree
  add_index "spaces", ["booking_rate_weekly"], name: "index_spaces_on_booking_rate_weekly", using: :btree
  add_index "spaces", ["latitude"], name: "index_spaces_on_latitude", using: :btree
  add_index "spaces", ["longitude"], name: "index_spaces_on_longitude", using: :btree
  add_index "spaces", ["owner_id"], name: "index_spaces_on_owner_id", using: :btree
  ...
  add_index "user_photos", ["flickr_id"], name: "index_user_photos_on_flickr_id", using: :btree
